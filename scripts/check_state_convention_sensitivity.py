...
Usage:
    ...
    python3 scripts/check_state_convention_sensitivity.py --dataset-root ../data_two_color \
...
import diagnose_language_grounding as dlg  # noqa: E402
...
def main():
    ...
    tool_offset = np.load(os.path.join(SCRIPT_DIR, "tool_offset.npy"))
