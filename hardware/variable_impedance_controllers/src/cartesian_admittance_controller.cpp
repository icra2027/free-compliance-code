...
#include <variable_impedance_controllers/cartesian_admittance_controller.hpp>
...
PLUGINLIB_EXPORT_CLASS(
  variable_impedance_controllers::CartesianAdmittanceController, controller_interface::ControllerInterface)
