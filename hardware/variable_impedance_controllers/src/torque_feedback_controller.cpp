...
#include <variable_impedance_controllers/torque_feedback_controller.hpp>
...
PLUGINLIB_EXPORT_CLASS(
  variable_impedance_controllers::TorqueFeedbackController, controller_interface::ControllerInterface)
