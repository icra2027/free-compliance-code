...
TEST(PseudoInverseTest, SquareMatrixTest) {
  ...
  Eigen::MatrixXd A_pinv = variable_impedance_controllers::pseudo_inverse(A);
...
TEST(PseudoInverseTest, RectangularMatrixTest) {
  ...
  Eigen::MatrixXd B_pinv = variable_impedance_controllers::pseudo_inverse(B);
...
TEST(PseudoInverseTest, MoorePenroseTest) {
  ...
  Eigen::MatrixXd C_pinv = variable_impedance_controllers::pseudo_inverse_moore_penrose(C);
...
TEST(PseudoInverseTest, ZeroMatrixTest) {
  ...
  Eigen::MatrixXd D_pinv1 = variable_impedance_controllers::pseudo_inverse(D);
  Eigen::MatrixXd D_pinv2 = variable_impedance_controllers::pseudo_inverse_moore_penrose(D);
