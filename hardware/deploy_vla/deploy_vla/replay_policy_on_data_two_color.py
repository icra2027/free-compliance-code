...
# Controller-realizable stiffness range from the proposal (deploy_smolvla.py's own
...
def load_trimmed_episode_with_images(session, episode_index, use_tool_offset=True):
    ...
    # the flange (scripts/calibrate_tool_offset.py); --no-tool-offset skips loading it
