"""Final B0-B5 real-hardware evaluation runner (E1/E2: 6 policies x 20
rollouts, etc.) -- built on deploy_smolvla.py's SmolVLADeployment
...
Metrics this script computes per-rollout vs. what it only
records the signal for, since some of the metrics are cross-rollout
...
B1 (B0's policy, run through the same low-level controller
...
# compliance-vla/data_extraction is under a src/ sibling of this package -- same
    ...
    try:
        while running and rclpy.ok():
            ...
            if freeze_force_history and force_history is not None:
                ...
                # input" (the modal-masking risk). Freezing at a real,
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--n-rollouts", type=int, default=20, help="20 per policy for E1")
    ...
    try:
        ...
        for i in range(args.n_rollouts):
            ...
            summary = {
                ...
                # src/compliance_vla/policy/evaluate_gate3.py already parses from
