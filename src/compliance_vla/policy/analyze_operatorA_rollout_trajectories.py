...
There is no simulator and no real robot in this environment (smolvla_policy/README.md's
...
stitch, the same idea src/compliance_vla/policy/diagnose_language_grounding.py uses for a single
...
Usage:
    python -m compliance_vla.policy.analyze_operatorA_rollout_trajectories
    python -m compliance_vla.policy.analyze_operatorA_rollout_trajectories --steps 30000 --episodes-per-session 4
    python -m compliance_vla.policy.analyze_operatorA_rollout_trajectories --steps 5000 10000 30000 --n-plot-episodes 4
...
from compliance_vla.policy.serve_policy import load_policy  # noqa: E402
from compliance_vla.policy.diagnose_language_grounding import _load_manifest_ordered, _decode_array3d  # noqa: E402
